...
const Experience=()=>{
    return(
        <div className="w-[98%] bg-white mx-auto mt-10 flex flex-col gap-6 rounded-lg">
            ...
            <h1 className="sm:text-5xl text-3xl font-semibold text-[#111928] mt-6">
                3+ months of passion for </h1>
                <h1 className="sm:text-5xl text-3xl font-semibold text-[#111928]" >Programming techniques</h1>
            <div className="mt-10 grid sm:grid-cols-2 sm:grid-rows-1 grid-cols-1 grid-rows-2 gap-6">
                <div className="w-full h-full  rounded-lg flex flex-col  ">
                    <div className="border-2 border-[#cfcfd0] xl:pl-4 py-3  rounded-xl flex">
                        ...
                        <h1 className="text-2xl font-semibold text-[#111928]"> Technohacks</h1>
                    ...
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTK1C6QJwhM6bC0NqNyxiX3-HwyZTiEr91d5g&s" className="w-14 h-14 my-auto mx-3 " alt="" />
                        <div className="flex-grow">
                        <h1 className="text-2xl font-semibold text-[#111928]"> Google Developer Student Club</h1>
                    ...
                    <img src="https://upload.wikimedia.org/wikipedia/en/e/e0/Csi_logo_india.jpg" className="w-14 h-14 my-auto mx-3" alt="" />
                        <div className="flex-grow">
                        <h1 className="text-2xl font-semibold text-[#111928]"> Computer Society of India</h1>
                ...
                <div className="mt-6  ">
                    ...
                    <ul className="list-disc space-y-3  font-mono text-lg text-[#363A40] text-justify">
  <li>
