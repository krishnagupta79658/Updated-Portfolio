        ...
        <div className=" dark:bg-[#161616] mx-auto p-3 flex flex-col-reverse md:flex-row gap-5 bg-[#d5d5d5] mt-10 pt-10 items-center" id="contact">
            <div className="md:w-5/12 h-fit p-1  flex flex-col justify-center items-center">
                ...
                <div className="text-lg flex gap-5 justify-between">
                    <a href="#home" className="text-lg hover:text-[#1F7B57] hover:scale-125 transition-all duration-150 dark:text-[#8B8F98]">Home</a> 
                    <a href="https://drive.google.com/file/d/1pfShQ5tel4HmNN1Je9pxdMBJ3Z6D9fxi/view?usp=sharing" className="text-lg hover:text-[#1F7B57] hover:scale-125 transition-all duration-150 dark:text-[#8B8F98]">Resume</a>
                    <a href="#projects" className="text-lg hover:text-[#1F7B57] hover:scale-125 transition-all duration-150 dark:text-[#8B8F98]">Projects</a>
                </div>
            </div>
            <div className="md:w-6/12 h-git p-4 border-2 rounded-lg border-black dark:bg-black dark:border-[#2D3236]">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-3">
                    <input type="text" placeholder="Your Name" className="border-2 border-gray-500 focus:border-transparent  rounded-lg p-2 outline-none focus:ring-2 focus:ring-[#1F7B57] dark:text-[#a0a0a0] " onChange={(e)=>setName(e.target.value)} value={name} />
                    <input type="email" placeholder="Your Email" className="border-2 border-gray-500 focus:border-transparent  rounded-lg p-2 outline-none focus:ring-2 focus:ring-[#1F7B57] dark:text-[#a0a0a0]" onChange={(e)=>setEmail(e.target.value)} value={email} />
                    <textarea name="" id="" cols="30" rows="5" placeholder="Your Message" className="border-2 border-gray-500 focus:border-transparent  rounded-lg p-2 outline-none focus:ring-2 focus:ring-[#1F7B57] dark:text-[#a0a0a0]" onChange={(e)=>setMessage(e.target.value)} value={message}></textarea>
