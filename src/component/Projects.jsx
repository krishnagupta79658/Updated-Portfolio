  ...
  ScrollTrigger.matchMedia({
    ...
    return(
        <div id="projects" className="w-[98%] dark:bg-black mx-auto mt-10 flex flex-col gap-1 sm:p-6 p-3 bg-white rounded-lg dark:border-2 dark:border-[#2D3236]">   
            ...
            {/* projects 1 */}
            <div className="lg:w-11/12 bg-white mx-auto h-fit flex flex-col gap-4 justify-center items-center mt-10 z-30">
            ...
            {/* project 2 */}
            <div className="lg:w-11/12 bg-white mx-auto h-fit flex flex-col gap-4 justify-center items-center mt-10 z-20">
            ...
            {/* project 3 */}
            <div className="lg:w-11/12 bg-white mx-auto h-fit flex flex-col gap-4 justify-center items-center mt-10 z-10">
                <div className="w-full  flex flex-row justify-between lg:gap-4 rounded-lg border-2 border-[#737373] p-4">
                    <div className="w-4/12 hidden lg:block">
