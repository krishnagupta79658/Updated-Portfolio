...
function Home(){
    return(
        <div id="home">
        <div className="flex w-[98%] bg-white min-h-[25rem] mx-auto gap-6 mt-24 sm:p-6 p-3 flex-col-reverse lg:flex-row justify-center items-center  inset-0 rounded-lg relative">
            ...
            <div className=" w-full sm:w-xl sm:mx-auto ">
                <div className='h-fit flex flex-col justify-center p-1 lg:pr-4 '>
                    <h3 className=' text-sm text-[#767D84] lg:text-lg'> <span className='text-[rgb(248,100,101)]'>{"<span>"}</span> Hey  I'm Abhishek Kumar <span className='text-[#F86465]'>{"</span>"}</span></h3>
                    <p className='text-xl text-[#111928] mt-5 lg:text-3xl '> Junior <span className='text-[#1F7B57]'>{'{Frontend Developer}'}</span> | ReactJS &</p>
                    <p className='text-xl text-[#111928]  lg:text-3xl '> <span className='text-[hsl(157,60%,30%)]'> {'{Backend Developer}'}</span> | Django </p>
                    <p className='mt-5 text-sm lg:text-lg text-wrap text-[#6D737F] text-justify '> <span className='text-[#F86465] pl-1'>{"<p>"}</span>I’m a developer focused on <span className='text-[#F86465] pr-1'>Django , Django Restframework and ReactJS.</span>
        ...
        <div className='w-[98%] mt-4 mx-auto flex justify-evenly py-3 bg-white sm:flex-row flex-col gap-10 rounded-lg shadow-md items-center sm:items-start'>
            <div className='sm:w-2/12 md:3/12 h-fit my-6  '>
            <img src={calendar} className='w-8 h-8 mx-auto sm:mx-0' alt="" /> 
            <h3 className='text-black text-4xl font-semibold py-2 sm:text-start text-center '> 6+  </h3>
            <p className='text-lg text-[#5F6673]'> Hey, months Experience </p>
            </div>
            <div className='sm:w-2/12 md:3/12 h-fit my-6 '>
            <img src={project} className='w-8 h-8 mx-auto sm:mx-0' alt="" />
            <h3 className='text-black text-4xl font-semibold py-2 sm:text-start text-center'> 3+  </h3>
            <p className='text-lg text-[#5F6673]'> Projects Completed </p>
            </div>
            <div className='sm:w-2/12 md:3/12 h-fit my-6 '>
            <img src={certificate} className='w-8 h-8 mx-auto sm:mx-0' alt="" />
            <h3 className='text-black text-4xl font-semibold py-2 sm:text-start text-center'> 5+  </h3>
