    ...
    return(
        <div className="w-[98%] bg-white dark:bg-black mx-auto mt-10 flex flex-col  p-4 rounded-lg " id="skills">
            <div className="w-full text-center">
                ...
                <h1 className="text-5xl font-semibold text-black dark:text-[#DAE2F0] "> My Skills</h1>
            </div>
            ...
            <div className="flex sm:flex-wrap  justify-evenly border-2 border-gray-200 rounded-lg overflow-x-hidden dark:bg-black dark:border-2 dark:border-[#2D3236]">
